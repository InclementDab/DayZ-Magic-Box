...
```
1.) Clone into hard drive outside of your P drive
2.) Use VSCode to rename every instance of MagicBox to your ModPrefixName, and manually rename the two folders
...
Any folders inside of the MagicBox directory will be converted into PBO's (excluding the Workbench folder)
